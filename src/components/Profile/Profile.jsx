    ...
    return (
        <div className="bg-white relative shadow rounded-lg w-5/6 md:w-4/6  lg:w-3/6 xl:w-2/6 mx-auto">
            <div className="flex justify-center">
                <img src="https://avatars0.githubusercontent.com/u/35900628?v=4" alt="" className="rounded-full w-16 h-16 shadow-md border-4 border-white transition duration-200 transform hover:scale-110" />
            </div>
            <div className="">                            
                <h1 className="font-bold text-center text-3xl text-gray-900">GameChat</h1>
                <p>
                    <span></span>
                </p>
                <div className="flex flex-row items-center content-center">
                    <div className="my-5 px-3">
                        <button onClick={() => setOpen(true)}>
                            <a href="#" className="w-36 text-gray-200 block rounded-lg text-center font-medium leading-6 px-6 py-3 bg-gray-900 hover:bg-black hover:text-white">XMTP Chat</a>
                        </button>
                    </div>

                    <div className="my-5 px-3">
                    <button onClick={() => setOpen(true)}>
                            <a href="#" className="w-36 text-gray-200 block rounded-lg text-center font-medium leading-6 px-6 py-3 bg-gray-900 hover:bg-black hover:text-white">zkDiD</a>
                        </button>
                    </div>
                </div>
                <div className="my-2 px-1">
                    <button onClick={isAuthenticated ? disconnectWallet : connectWallet}
                            id="wallet-connect"
                        >
                            <a href="#" className="w-50 text-gray-200 block rounded-lg text-center font-medium leading-6 px-6 py-1 bg-gray-900 hover:bg-black hover:text-white">{isAuthenticated ? "Disconnect Wallet" : "Connect Wallet"}</a>
                        </button>
                    </div>


                <div className="w-full text-left">
                    <h3 className="font-medium text-gray-900 text-center mt-6 px-6">Recent Messages</h3>
